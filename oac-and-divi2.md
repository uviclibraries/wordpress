...
1. **Create a Page**
  - From the Dashboard of your site, click on **Page** in the left sidebar menu and then click on **Add New**. <img src="images/oacdivibuilder.PNG" style="float:right;width:120px;" alt="Button for Use the Divi Builder">
  - Click on the **Use the Divi Builder** button. Then three options will pop up. Click on **Browse Layouts**. This will bring up the Layout Packs Library. This is an extensive collection of layouts available to use (as of creating this tutorial, 2547 layouts are available in 347 layout packs). <img src="images/oacbrowserlayouts.PNG" style="float:right;width:150px;" alt="Pop-up for Browse Divi Layouts">
